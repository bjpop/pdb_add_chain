...
this_program_name="pdb_add_chain-test.sh"
...
${this_program_name}: run integration/regression tests for pdb_add_chain 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/pdb_add_chain -d data/tests
